<?php
    ...
    $envio_comentario = mysqli_query($conexao, "INSERT INTO comentarios(email_autor, comentario) VALUES ('$login','$comentario')");
}
?>
...
<body>
    <div id="envio_comentario">
        <br>
        <h1 id="titulo-pag">Seu comentário foi enviado com sucesso!</h1>
            <p id="texto-atualizado"><u><a href="acesso.php">Voltar para a página principal</a></u></p>
    </div>
